...
function winner (){
    ...
    }else if(square[4] == square[5] && square[6] == square [4] && square[4] != ''){
        end(4,5,6)
    }else if(square[7] == square[8] && square[8] == square [9] && square[9] != ''){
        end(7,8,9)
    }else if(square[1] == square[4] && square[7] == square [4] && square[7] != ''){
        end(1,4,7)
    }else if(square[2] == square[5] && square[5] == square [8] && square[8] != ''){
        end(2,5,8)
    }else if(square[3] == square[6] && square[6] == square [9] && square[9] != ''){
        end(3,6,9)
    }else if(square[1] == square[5] && square[9] == square [5] && square[9] != ''){
        end(1,5,9)
